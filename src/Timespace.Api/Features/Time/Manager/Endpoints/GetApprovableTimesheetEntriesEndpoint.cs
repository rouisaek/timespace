...
namespace Timespace.Api.Features.Time.Manager.Endpoints;

[GeneratePermissionPolicy]
public static class GetApprovableTimesheetEntriesEndpointPolicy
{
	public const string PolicyName = "timespace:manager:timesheet:view-approvable-entries";
}

[Handler]
[MapGet("/api/manager/timesheet/approvable-entries")]
