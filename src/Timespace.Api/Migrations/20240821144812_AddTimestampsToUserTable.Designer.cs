...
namespace Timespace.Api.Migrations
{
    ...
    [Migration("20240821144812_AddTimestampsToUserTable")]
    partial class AddTimestampsToUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Timespace.Api.Features.Users.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<Instant>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(NodaTime.Instant.FromUnixTimeTicks(17242516922604360L));
            ...
            modelBuilder.Entity("Timespace.Api.Features.Timesheet.Models.TimesheetEntry", b =>
                {
                    ...
                    b.HasOne("Timespace.Api.Features.Tenants.Models.TenantUser", "TenantUser")
