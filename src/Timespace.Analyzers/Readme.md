...
### Timespace.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [Timespace.Analyzers.Sample.csproj](../Timespace.Analyzers.Sample/Timespace.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### Timespace.Analyzers.Tests
