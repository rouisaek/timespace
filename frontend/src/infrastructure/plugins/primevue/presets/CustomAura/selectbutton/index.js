export default {
	root: ({ props }) => ({
		class: [
			'inline-flex flex-col md:flex-row select-none align-bottom outline-transparent',
			'border rounded-md [&>button]:rounded-none [&>button]:border-none [&>button]:flex-grow',
