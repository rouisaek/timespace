...
import { getRules, type InputAutoCompleteProps } from "../FormInputTypes";
import AutoComplete from "primevue/autocomplete";

const props = defineProps<InputAutoCompleteProps>();
...
// inputProps.suggestions = computed(() => attrs.suggestions ?? []);
