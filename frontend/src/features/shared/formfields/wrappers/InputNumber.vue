<template>
    ...
    <div class="field w-full mt-6">
        <div class="p-float-label w-full">
            <InputNumber :id="id" v-bind="componentAttributes" v-model="v$.modelValue.$model" :class="componentClasses">
...
import { computed, reactive, useAttrs, watch, type PropType } from "vue";
import { getRules, type InputNumberProps } from "../FormInputTypes";
