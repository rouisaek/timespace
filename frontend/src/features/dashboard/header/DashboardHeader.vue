...
<template>
	...
	>
		...
		<div
			class="flex items-center lg:hidden rounded dark:hover:bg-slate-700 hover:bg-slate-100 cursor-pointer"
		>
			<iconify-icon
				icon="heroicons:bars-3"
				height="none"
				class="h-8 w-8 text-tprimary"
