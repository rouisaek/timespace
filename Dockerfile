...
RUN dotnet restore "src/Timespace.Api/Timespace.Api.csproj" -a $TARGETARCH
COPY . .
...
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "Timespace.Api.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false -a $TARGETARCH
